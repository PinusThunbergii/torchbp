...
TORCH_LIBRARY(torchbp, m) {
  ...
  m.def("blocksvd_alpha(Tensor img, Tensor data, Tensor pos, Tensor blocks, int sweep_samples, int nsweeps, int nblocks, int Ntheta, float fc, float r_res, float r0, float dr, float theta0, float dtheta, float d0, float data_fmod, Tensor dem) -> Tensor");
  ...
  m.def("ffbp_merge2_knab(Tensor img0, Tensor img1, Tensor dorigin, float fc, Tensor r0, Tensor dr0, Tensor theta0, Tensor dtheta0, Tensor Nr0, Tensor Ntheta0, float r1, float dr1, float theta1, float dtheta1, int Nr1, int Ntheta1, float z1, int order, float oversample, int alias, float alias_fmod, Tensor dem, float m2_0=0., float m2_1=0.) -> Tensor");
  m.def("ffbp_merge2_poly(Tensor img0, Tensor img1, Tensor dorigin, float fc, Tensor r0, Tensor dr0, Tensor theta0, Tensor dtheta0, Tensor Nr0, Tensor Ntheta0, float r1, float dr1, float theta1, float dtheta1, int Nr1, int Ntheta1, float z1, int order, Tensor poly_coefs, int alias, float alias_fmod, Tensor dem, float m2_0=0., float m2_1=0., ScalarType? out_dtype=None) -> Tensor");
  m.def("ffbp_merge2_poly_weighted(Tensor img0, Tensor img1, Tensor dorigin, float fc, Tensor r0, Tensor dr0, Tensor theta0, Tensor dtheta0, Tensor Nr0, Tensor Ntheta0, float r1, float dr1, float theta1, float dtheta1, int Nr1, int Ntheta1, float z1, int order, Tensor poly_coefs, int alias, float alias_fmod, Tensor w1_map0, Tensor w2_map0, float w_r0_0, float w_dr0, float w_theta0_0, float w_dtheta0, int w_nr0, int w_ntheta0, Tensor w1_map1, Tensor w2_map1, float w_r0_1, float w_dr1, float w_theta0_1, float w_dtheta1, int w_nr1, int w_ntheta1, int output_weight_map, int output_weight_decimation, Tensor dem, float m2_0=0., float m2_1=0., ScalarType? out_dtype=None) -> Tensor[]");
